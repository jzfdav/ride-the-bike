        ...
        >
                    ...
                    return (
                        <div
                            ...
                            className={cn(
                                ...
                                isActive
                                    ? (barIndex <= 1 ? "bg-red-500 h-8 shadow-[0_0_10px_rgba(239,68,68,0.4)]" : "bg-pulsar-blue h-8 shadow-[0_0_10px_rgba(0,82,204,0.4)]")
                                    : "bg-white/5 h-4"
                            )}
                        />
                    );
            ...
            <div className="flex justify-between items-end">
                <div className="space-y-1">
                    <div className="text-[9px] text-oled-gray-400 uppercase tracking-widest font-bold">Average efficiency</div>
                    <div className="flex items-baseline gap-2">
                        <div className="text-2xl font-black tracking-tighter text-glow-pulsar">
                            {typeof avgFE === 'number' && avgFE > 0 ? avgFE : (fuelLog.length > 0 ? avgFE : "--.-")}
                        </div>
                        <div className="text-[10px] font-black text-oled-gray-400">KM/L</div>
                    </div>
                </div>
