					...
					<div className="flex items-center gap-3">
						<span
							className={cn(
								...
								chainHealth > 50
									? "border-pulsar-blue/30 text-pulsar-blue"
				...
				<div className="grid grid-cols-[1fr,auto] gap-4 items-end">
					<div className="space-y-2">
						<div className="text-3xl font-bold tracking-tighter text-glow-pulsar">
							{chainHealth}%{" "}
							<span className="text-sm font-medium opacity-50">HEALTH</span>
						</div>
						<div className="w-full bg-white/5 rounded-full h-1 overflow-hidden">
							<motion.div
								...
								className={cn(
									...
									chainHealth > 50
										? "bg-pulsar-blue shadow-[0_0_10px_rgba(0,82,204,0.3)]"
										: "bg-warning-orange shadow-[0_0_10px_rgba(255,107,53,0.3)]",
								)}
							/>
						</div>
					</div>
